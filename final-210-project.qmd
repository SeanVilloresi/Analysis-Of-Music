...
The distribution of the response variable Stream is skewed to the right with most of the data having lower values for Streams. This is understandable because a handful of songs are extremely popular while most songs on Spotify tend to be listened to by specific niches of people.
...
kable(summary_df, caption = "Summary Statistics of Three Columns")
```
